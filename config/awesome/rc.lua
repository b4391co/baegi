...
{description = "Move client to next tag", group = "client" }),
    ...
    awful.key({ alt,           }, "Tab", function () awful.spawn("rofi -show window -show-icons -theme ~/.config/rofi/themes/spotlight-dark.rasi") end,
    {description = "rofi", group = "launcher"}),
    awful.key({ super,  "Shift"  }, "r", function () awful.spawn("rofi -show ssh -show-icons -theme ~/.config/rofi/themes/spotlight-dark.rasi") end,
    {description = "rofi", group = "launcher"}),
...
local wallpaper_cmd="feh --bg-fill /home/b4391co/Imágenes/walpaper.png"
