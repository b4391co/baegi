...
{description = "Move client to next tag", group = "client" }),
    ...
    awful.key({ modkey, "Control" }, "v", function () awful.spawn("vivaldi-stable") end,
    ...
    awful.key({ "Mod4"            }, "r", function () awful.spawn("rofi -show run -show-icons -theme ~/.config/rofi/themes/rounded-blue-dark") end,
    {description = "rofi", group = "launcher"}),
    awful.key({ modkey,           }, "Tab", function () awful.spawn("rofi -show window -show-icons -theme ~/.config/rofi/themes/rounded-blue-dark") end,
    {description = "rofi", group = "launcher"}),
    awful.key({ "Mod4",  "Shift"  }, "r", function () awful.spawn("rofi -show ssh -show-icons -theme ~/.config/rofi/themes/rounded-blue-dark") end,
    {description = "rofi", group = "launcher"}),
    awful.key({ "Mod4",           }, "l", function () awful.spawn("i3lock-everblush") end,
